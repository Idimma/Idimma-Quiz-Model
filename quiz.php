        ...
        <div class="modal-body disabled">
            <form class="choices" id="choice">
                <div class="row opt">
                    ...
                    <label class=" col-lg-6 col-md-6 col-sm-6" id="A">
                        <input type="radio" name="opt" value="A" id="opt1"/>
                    </label>
                    <label class=" col-lg-6 col-md-6 col-sm-6" id="B">
                ...
                <div class="row opt">
                    <label class="col-lg-6 col-md-6 col-sm-6" id="C">
                        <input type="radio" name="opt" value="C" id="opt3"/>
                    </label>
                    <label class="col-lg-6 col-md-6 col-sm-6" id="D">
