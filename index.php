...
<div>
    <header class="row body_header " style="color: white">
        <div class="col-md-3 text-center">
            <img src="images/NYSC-LOGO.png" height="80px">
        </div>
        <div class="col-md-6 text-center">
            <h2 style="text-align: center; ">EDUCATIONAL DEVELOPMENT GROUP, ILORIN SOUTH</h2>
        </div>
        <div class="col-md-3 text-center">
            <img src="images/NYSC-LOGO.png" height="80px">
        </div>
    ...
    <main class="modal-content dashboard row" style="width: 80%; height: auto; margin: auto;    padding: 7px;    border-radius: 5px;    border: 1px #ccc solid;
    position: relative;">
        <!--<div class="dashboard">-->
